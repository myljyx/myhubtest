...
//			throw new IllegalStateException("can not change the properties of an activated component instance");
//		}
...
//		}
	...
	void log(String message, Throwable e){
		...
		LogManager.getInstance().error(message, e);
...
//			if (dynamicReferences != null){
//				for (Reference r : dynamicReferences){
//					r.reset();
//				}
//			}
		}
...
//				}
	...
	//TODO: for carefull type config use in the future
...
//		}
	...
	public String toString() {
		...
		sb.append("[").append(component != null ? component.definition.implement.getSimpleName() : "")
		.append("]");
		return sb.toString();
	}
}
