...
public class MultiValuedFieldIndex<T> extends GeneralFieldIndex<T> {

	public MultiValuedFieldIndex() {
	}
	
	public MultiValuedFieldIndex(String field, ObjectAccessor<T> fieldAccessor){
