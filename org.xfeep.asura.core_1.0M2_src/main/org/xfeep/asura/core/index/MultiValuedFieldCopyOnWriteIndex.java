...
public class MultiValuedFieldCopyOnWriteIndex<T> extends GeneralFieldCopyOnWriteIndex<T> {

	public MultiValuedFieldCopyOnWriteIndex() {
	}
	
	public MultiValuedFieldCopyOnWriteIndex(String field, ObjectAccessor<T> fieldAccessor){
